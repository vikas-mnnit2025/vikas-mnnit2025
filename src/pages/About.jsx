...
const About = () => {
  return (
    <div>
      <section className="bg-caribbeangreen-700">
        <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
          <header className="mx-auto py-20 text-4xl font-semibold lg:w-[70%]">
            ...
            <p className="mx-auto mt-3 text-center text-base font-medium text-richblack-5 lg:w-[95%]">
              EdTechAdda is at the forefront of driving innovation in online
      ...
      <section className="border-b border-richblack-700">
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-5">
